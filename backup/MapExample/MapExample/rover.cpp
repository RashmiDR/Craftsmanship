...
void Rover::moveFront()
{
	...
	{
		case DIRECTION_EAST:
			isMoveComplete = sphere.changeX(currentPosition, INCREMENT, obstaclePoint);
			break;
            
		case DIRECTION_WEST:
			isMoveComplete = sphere.changeX(currentPosition, DECREMENT, obstaclePoint);
			break;
            
		case DIRECTION_NORTH:
			isMoveComplete = sphere.changeY(currentPosition, INCREMENT, obstaclePoint);
			break;
            
		case DIRECTION_SOUTH:
			isMoveComplete = sphere.changeY(currentPosition, DECREMENT, obstaclePoint);
			break;
